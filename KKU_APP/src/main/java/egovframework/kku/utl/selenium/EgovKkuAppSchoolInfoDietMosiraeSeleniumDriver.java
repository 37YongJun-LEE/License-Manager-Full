...
//모시래학사 학식정보 크롤러
public class EgovKkuAppSchoolInfoDietMosiraeSeleniumDriver {
...
//	public static String WEB_DRIVER_PATH = "C:/eGovFrameDev-3.10.0-64bit/webdriver/chromedriver107/chromedriver.exe";
	...
	public EgovKkuAppSchoolInfoDietMosiraeSeleniumDriver() {
		chrome();
	}
...
//		options.addArguments("--window-size='1280,1600'");
	...
	public String[][][] useDriver(String url) throws Exception {
		driver.get(url);
		Thread.sleep(2000);
		driver.findElement(By.cssSelector("#wrap > div.sitemap > details > div > div > div > dl:nth-child(2) > dd > ul > li:nth-child(3) > ul > li:nth-child(4) > a > span")).click();
		Thread.sleep(1000);
		
		String[][][] dataList2  = new String[3][7][6];
		for(int i=1; i<4; i++) {
			for(int j=2; j<9; j++) {
