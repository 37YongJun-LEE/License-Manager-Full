...
public class EgovKkuAppMypageServiceImpl extends EgovAbstractServiceImpl implements EgovKkuAppMypageService {
	...
	public List<?> selectFriendStatus(EgovKkuAppFriendVO friendVO) {
		return mypageDAO.selectFriendStatus(friendVO);
	}

	@Override
	public List<EgovMap> selectMyReportListbyUsrIdx(EgovKkuAppUserVO uVO) throws Exception {
		return mypageDAO.selectMyReportListbyUsrIdx(uVO);
	}
