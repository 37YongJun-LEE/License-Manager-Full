...
public class EgovKkuAdmLicenseVO extends ComDefaultVO{
	...
	//interest_reco
	private String recSubjectCd;
	private String recSubjectName;
	...
	//uni_reco
	private String uniIdx;
	private String pilsooYn;
	...
	public String getRecSubjectCd() {
		return recSubjectCd;
	}
	public void setRecSubjectCd(String recSubjectCd) {
		this.recSubjectCd = recSubjectCd;
	}
	public String getRecSubjectName() {
		return recSubjectName;
	}
	public void setRecSubjectName(String recSubjectName) {
		this.recSubjectName = recSubjectName;
	}
	...
	public String getBoardViewnum() {
		return boardViewnum;
	}
	public void setBoardViewnum(String boardViewnum) {
	...
	public String getUniIdx() {
		return uniIdx;
	}
	public void setUniIdx(String uniIdx) {
		this.uniIdx = uniIdx;
	}
	public String getPilsooYn() {
		return pilsooYn;
	}
	public void setPilsooYn(String pilsooYn) {
		this.pilsooYn = pilsooYn;
	}
