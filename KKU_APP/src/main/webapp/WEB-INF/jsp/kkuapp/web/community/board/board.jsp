			...
			<div class="w_box no_line">
				...
				<div class="list_top">
					<p class="left sub_tab">
						<a href="board.do" class="btn_mini state <c:if test="${state eq 'board' }">on</c:if>">모든 게시물</a> <!-- 해당 버튼에 클래스 on을 넣어주세요 -->
						<a href="boardTop.do" class="btn_mini state <c:if test="${state eq 'boardTop' }">on</c:if>">인기 게시물</a> 					
					</p>
