	...
	<!-- CONTENTS BEGIN -->
		<div id="sub_contents" class="board head_mg mb140">
			...
			<form name="frm" id="frm" autocomplete="off" method="post" enctype="multipart/form-data">
				<p class="path mb10">${name }</p>
				 <input type="hidden" name="bthemeName" value="${name }"/>
				  <input type="hidden" name="tboardDetailname" value="${name }"/>
				<textarea rows="10" name="tboardContent" id="tboardContent" placeholder="게시물 내용 입력"></textarea>
				<div class="add_photo">
	...
	<div class="layer" id="ok_Pop">
		...
		<div class="pop-layer" id="okPop">
			<div class="pop_cont text">
				...
				<p class="btn"><a href="/themeboard.do?bthemeName=${name }">확인</a></p>
			</div> 
		</div>
	</div>
	<!-- POPUP END -->
