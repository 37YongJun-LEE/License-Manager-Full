...
<body>
	...
	<!-- CONTENTS BEGIN -->
		<div id="sub_contents" class="head_mg mb140">
			...
			<div class="tab">
				<ul>
					<li><a href="/mypage/myTrade01.do">판매 내역</a></li>
					<li><a href="#" class="on">찜 목록</a></li>
				</ul>
			</div>
	...
	<div class="layer" id="del_Pop">
		...
		<div class="pop-layer" id="delPop">
			<div class="pop_cont text">
				<p class="mb20 c">찜 목록에서 삭제하시겠습니까?</p>
				<p class="two_btn btn"><a href="#">확인</a><a href="#" class="cbtn bt_red">아니오</a></p>
			</div> 
		</div>
	</div>
	<!-- POPUP END -->
...
<script>
//하트버튼에 부모 onclick 이벤트 방지
$('.heart_btn').click(function(e){ e.stopPropagation(); });
</script>