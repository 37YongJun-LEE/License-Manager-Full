	...
	<!-- CONTENTS BEGIN -->
		<div id="sub_contents" class="board head_mg mb140">
			...
			<form name="frm" id="frm" autocomplete="off" method="post" enctype="multipart/form-data">
				...
				<input type="text" name ="boardTitle" id="boardTitle" placeholder="게시물 제목 입력" class="mb10"/>
				...
				<p class="btn mt10"><a href="#" onclick="fnsubmit()">작성완료</a></p>
				</div>
