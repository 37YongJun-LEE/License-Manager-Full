...
function submit(){
	...
	if(	$("#clubBoardTitle").val() != null && $("#clubBoardContent").val() != null){
		...
		$.ajax({
			type : "POST",
			url : "/club_gallery_write_process.do",
			data: formData,
	        ...
	        enctype : 'multipart/form-data', // * 중요 *
				success: function(tmp) {
					if(tmp == "success"){
						...
						alert("작성되었습니다.");
						location.href="/club_gallery.do?clubIdx=${clubVO.clubIdx}"
	...
	<div id="wrap">
		...
		<div id="sub_contents" class="board head_mg mb140">
			...
			<form name="frm" id="frm" autocomplete="off" method="post" enctype="multipart/form-data">
				...
				<input type="hidden" name="clubBoardType" value="GALLERY"/>
				<input type="text" name ="clubBoardTitle" id="clubBoardTitle" placeholder="게시물 제목 입력" class="mb10"/>
				<textarea rows="10"name ="clubBoardContent"  id="clubBoardContent" placeholder="게시물 내용 입력"></textarea>
				<div class="add_photo">
						...
						<ul class="file_wrap">
									<c:forEach var="file" items="${fileList }">
										...
										<span><img src="/_img/_img/cont/photo_thum.png" width="65" height="65" style="background:url(/upload/clubBoard/${clubVO.clubIdx }/${file.fileSrvFile })no-repeat 50% 50% / cover"></span>
