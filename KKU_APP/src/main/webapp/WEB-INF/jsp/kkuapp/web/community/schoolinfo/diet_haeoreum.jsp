			...
			<div class="w_box top no_line">
				<div class="list_top mt0">
					<p class="left sub_tab">
						<a href="diet_haeoreum.do" class="btn_mini state on">해오름 학사</a>
						<a href="diet_mosirae.do" class="btn_mini state">모시래학사</a> <!-- 해당 버튼에 클래스 on을 넣어주세요 -->
					</p>
					<!-- <a href="https://dorm.kku.ac.kr/main.do" class="btn_mini bt_greenL">식단 전체보기</a> -->
				</div>
				<p style="font-size:15px;">최근 업데이트일 ${update}</p>
				<p class="diet_top">※ 식단정보은 해오름학사 홈페이지에 업로드 되는 주간메뉴 자료로 제공됩니다.</p>
				...
				<div class="diet_wrap">
					...
					<c:choose>
						...
						<c:forEach var="dietInfo" items="${todayDietInfo}">
							<div>
								<div class="tt"><p>${dietInfo.weekmenuCategory }</p><span></span></div>
								<ul class="food_list">
								<c:choose>
