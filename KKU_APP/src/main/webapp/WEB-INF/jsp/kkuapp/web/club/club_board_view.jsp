...
<body>
	<div id="wrap">
		...
		<div id="sub_contents" class="board head_mg mb140">
			<div class="navi">
				<div class="top_navi"><a href="javascript:history.back(-1)"><img src="/_img/_img/cont/navi_arrow.png"></a><h2>동아리 게시판</h2></div>
			</div>
			<div class="bbs_view">
				<div class="view_top">
					...
					<div class="writer"> 
						<a href="#" class="photo">
							<span>
							<c:if test="${galleryDetail.usrSrvprofilepic ne null }">
								<img src="/_img/_img/cont/photo_bg.png" style="background:url('/upload/mypage/${galleryDetail.usrSrvprofilepic}')no-repeat 50% 50% / cover" width="85">
							</c:if>
							<c:if test="${galleryDetail.usrSrvprofilepic eq null }">
								<img src="/_img/_img/cont/photo_bg.png" style="background:url('/_img/_img/cont/ex_photo.jpg')no-repeat 50% 50% /cover" width="85">
							</c:if>
								<!-- 기본이미지 -->
				...
				<div class="view_bottom">
					...
					<p class="btn nk_btn mt15">
						<a href="/club_board.do?clubIdx=${galleryDetail.clubIdx }" class="bt_greenL">목록</a>
			

					<c:if test="${galleryDetail.regIdx eq sessionIdx }">
						<a href="/club_board_modify.do?clubIdx=${galleryDetail.clubIdx }&clubBoardIdx=${galleryDetail.clubBoardIdx}" class="bt_gray02">수정</a>
