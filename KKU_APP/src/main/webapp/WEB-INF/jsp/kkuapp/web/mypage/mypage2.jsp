    ...
    filesArr.forEach(function(f) {
        ...
        if(sel_files){
    		if(confirm("프로필이미지를 변경하시겠습니까?")){
    			$("#fileForm").attr("action", "addPhoto.do");
    			$("#fileForm").submit();
    		}
        }
	...
	<!-- CONTENTS BEGIN -->
		<div id="sub_contents" class="my_main head_mg">
			...
			<div class="w_box">
				...
				<ul class="my_data">
					<li onclick="location.href='myCommunity.do'"><span>게시물</span><p>00<b>건</b></p></li>
					<li onclick="location.href='myTrade01.do'"><span>거래내역</span><p>${userInfo.tradeCnt }<b>건</b></p></li>
					<li onclick="location.href='myFriend.do'"><span>친구</span><p>00<b>명</b></p></li>
				</ul>
				<ul class="my_quick">
					
					<li onclick="location.href='myCommunity.do'">
						<p class="icon"></p>
						<p>게시글 관리</p>
					</li>
					<li onclick="location.href='myTrade01.do'">
						<p class="icon"></p>
						<p>거래내역</p>
					</li>
					<li onclick="location.href='myFriend.do'">
						<p class="icon"></p>
						<p>친구 목록</p>
					</li>
					...
					<ul>
						...
						<li>
							<form id="fileForm" name="fileForm" autocomplete="off" method="post" enctype="multipart/form-data">
								<input type="file" class="file" name="input_usr_img" id="input_usr_img" style="display: none"/>
