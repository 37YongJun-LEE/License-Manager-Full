		...
		<table class="table02" summary="관리자 기본정보 등록">
						...
						<tbody>
							<tr>
								...
								<td>
									<input style="width:100%" id="boardIdx" name="boardIdx" type="text" value="${freenoticeInfo.boardIdx }" readonly="readonly"/>    
									<p id="dupUsrIdYn" class="pass"> </p>
								</td>
								
								<th scope="row">제목<span class="star">*</span></th>
								<td>
									<input style="width:100%" type="text" id="boardTitle" name="boardTitle" value="${freenoticeInfo.boardTitle }" />
							...
							<tr>
								...
								<td>
									<input style="width:100%"type="text" id="boardWriter" name="boardWriter" value="${freenoticeInfo.boardWriter}" >
									<label class="f_0" for="">입력</label>
								</td>
								<th scope="row">작성일<span class="star">*</span></th>
								<td>
									<input style="width:180px"type="text" id="boardWritedate" name="boardWritedate" value="${freenoticeInfo.boardWritedate}" readonly="readonly" >
							...
							<tr>
								...
								<td class="ra_base" colspan="3" >
									...
									<input type="radio" id="boardStatusN" name="boardStatusYN" value="0"  <c:if test="${freenoticeInfo.boardStatus eq 0 }">checked</c:if>>
							...
							<tr>
								...
								<td colspan="3" >
									 <textarea id="boardContent" name="boardContent"  style="width:100%;height:890px;">${freenoticeInfo.boardContent }</textarea>
								</td>
					...
					<a href="/admin/freenoticeList.do" class="l btn_list">목록</a>
	...
	<jsp:attribute name="script_area">
		...
		function submit(){
			...
			$.ajax({
				type:"POST",
				data:{
					boardIdx: "${freenoticeInfo.boardIdx}",
					boardTitle: title,
					boardWriter: writer,
				...
				url:"/admin/freenoticeModifyAction.do",
				dataType:"text",
