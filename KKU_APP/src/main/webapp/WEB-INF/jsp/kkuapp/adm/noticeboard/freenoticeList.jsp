...
<t:searchable_board_list search_urls="/admin/freenoticeList.do" search_range_name="작성일" search_condition_name="검색구분" search_keyword_placeholder="검색어 입력">
	...
	<jsp:attribute name="body_area">
		<table class="table01" summary="회원 목록" >
			...
			<tbody>
		 	<c:forEach var="result" items="${freenoticeList}">
				<tr>
					<td>
					<input class="checkbox" type="checkbox" value="${result.boardIdx}" name="usrIdxArr" id="${result.boardIdx}" >
					...
					<td>${result.boardSt}</td>
					<td><p class="btn">
						<a href="/admin/freenoticeListDetail.do?boardIdx=${result.boardIdx}"  class="line" >수정</a><br>
					</p></td>
				</tr>		
			</c:forEach> 
			</tbody>
