		...
		<table class="table02" summary="부적합사항 등록">
			...
			<tbody>
				...
				<tr>
					...
					<th class="sub_th" colspan="2">조치예정일</th>
				</tr>
				<tr>
					<td colspan="3">
		...
		<table class="table02" summary="시정조치 계획/시정조치 내용 등록">
			...
			<tbody>
				<tr>
					...
					<td class="">
						${fn:split(fn:split(resultMap.disCbSubmitDate,' ')[0],'-')[0]}년 ${fn:split(fn:split(resultMap.disCbSubmitDate,' ')[0],'-')[1]}월 ${fn:split(fn:split(resultMap.disCbSubmitDate,' ')[0],'-')[2]}일<%-- ${fn:split(fn:split(resultMap.modDate,' ')[1],':')[0]}시 ${fn:split(fn:split(resultMap.modDate,' ')[1],':')[1]}분 --%>
					</td>
